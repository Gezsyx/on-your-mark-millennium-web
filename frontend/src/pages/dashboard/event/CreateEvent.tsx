...
const schema = z.object({
  name: z.string().min(2, "Nama event wajib diisi"),
  ...
  useEffect(() => {
    const fetchDropdownData = async () => {
      try {
        ...
        const speakData = await resSpeak.json();

        setCategories(catData.categories || catData.data || []);

        setSpeakers(speakData.data || []);
      } catch (err) {
    ...
    <div className="p-4">
      <div className="max-w-5xl mx-auto bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="border-b border-gray-100 px-8 py-6">
          ...
          <p className="text-gray-500 mt-1">Tambahkan event baru</p>
        </div>
